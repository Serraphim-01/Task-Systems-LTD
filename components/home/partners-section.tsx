      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
          {partners.map((partner: any) => {
            ...
            return (
              <Link key={partner.id} href={partner.link || '#'} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center p-4 bg-background rounded-lg shadow-md hover:shadow-lg transition-shadow h-24">
