import { getPageDescription, updatePageDescription, getAchievements, addAchievement, deleteAchievement } from './content-actions';
...
// --- Achievement List ---
function AchievementList({ achievements }: { achievements: any[] }) {
    const { toast } = useToast();
