                ...
                <FormField
                  ...
                  render={() => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="file" accept="image/*" {...register(`sections.${sectionIndex}.content.${contentIndex}.content.image`)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
    ...
    return (
        <div className="p-4 border rounded-md space-y-4">
            ...
            <div>
                ...
                <div className={`mt-2 grid gap-4 ${layout === 'two_column' ? 'grid-cols-2' : 'grid-cols-1'}`}>
