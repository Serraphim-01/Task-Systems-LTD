        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              >
                <h2 className="text-2xl font-bold text-[#ffbb00] mb-4">Mission</h2>
              ...
              <motion.div
                ...
                className="bg-card rounded-lg p-8 shadow-lg"
              >
                <h2 className="text-2xl font-bold text-[#ffbb00] mb-4">Vision</h2>
                <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <div>
                <h3 className="text-xl font-semibold text-[#ffbb00] mb-3">Charity</h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-[#ffbb00] mb-3">Empowerment</h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-[#ffbb00] mb-3">Education</h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-[#ffbb00] mb-3">Sponsorship</h3>
                <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-16 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <div>
                <h3 className="text-xl font-semibold text-[#ffbb00] mb-3">Commitment</h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-[#ffbb00] mb-3">Health & Safety</h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-[#ffbb00] mb-3">Quality Standard</h3>
                <p className="text-muted-foreground leading-relaxed">
